...
public class ShangpinDaoImpl extends BaseDao implements ShangpinDao {
    ...
    public int addShangpin(Shangpin shangpin) {
        String sql = "insert into shangpin (id,store_id storeId,gruop,type,name,description,standard,price,score,num,imgpath) " +
                "values(DEFAULT,?,?,?,?,?,?,?,?,?,?)";
        return baseUpdate(sql, shangpin.getStoreId(), shangpin.getGruop(),shangpin.getType() ,shangpin.getName(), shangpin.getDescription(),shangpin.getStandard(),shangpin.getPrice(),shangpin.getScore(),shangpin.getNum(),shangpin.getImgpath());
    }
    ...
    public int updateShangpin(Shangpin shangpin) {
        String sql = """
                UPDATE shangpin
                SET gruop = ?,type=?,name=?,description=?,standard=?,price=?,imgpath=?
                WHERE id=?;""";
    ...
    public Shangpin findShangpinById(int id) {
        String sql = "select id,store_id storeId,gruop,type,name,description,standard,price,score,num,imgpath from shangpin where id = ?";
    ...
    public List<Shangpin> findShangpinByName(String name) {
        String sql = "select id,store_id storeId,gruop,type,name,description,standard,price,score,num,imgpath from shangpin where title like ?";
        Object[] args = {"%" + name + "%"};
    ...
    public List<Shangpin> findShangpinByGroup(String group) {
        String sql = "select id,store_id storeId,gruop,type,name,description,standard,price,score,num,imgpath from shangpin where group = ?";
    ...
    public List<Shangpin> findAllShangpin() {
        String sql = "select id,store_id storeId,gruop,type,name,description,standard,price,score,num,imgpath from shangpin";
    ...
    public List<Shangpin> findShangpinByStoreId(String storeId) {
        String sql = "select id,store_id storeId,gruop,type,name,description,standard,price,score,num,imgpath from shangpin where store_id = ?";
